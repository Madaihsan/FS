...
const GoogleIcon = () => (
  <svg className="w-5 h-5" viewBox="0 0 48 48">
    ...
    <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.902,36.638,44,30.886,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
  </svg>
)
        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-4 mb-8">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 transition-colors"
            >
              <GoogleIcon />
              <span className="font-medium text-gray-700">Masuk Dengan Google</span>
            </button>
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-blue-600 text-white w-full py-3 rounded-md font-bold hover:bg-blue-700 transition-colors disabled:opacity-50"
            >
